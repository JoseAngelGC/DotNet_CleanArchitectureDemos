...
{
    public class MeasureUnitCatalogCrudInteractor : ICatalogUseCaseInputPort<MeasureUnitCatalog>
    {
        private readonly ICatalogQueryOperationsUseCase<MeasureUnitCatalog> _catalogQueryOperationsUseCase;
        private readonly ICatalogCommandOperationsUseCase<MeasureUnitCatalog> _catalogCommandOperationsUseCase;
        ...
        public MeasureUnitCatalogCrudInteractor(ICatalogQueryOperationsUseCase<MeasureUnitCatalog> catalogQueryOperationsUseCase, 
            ICatalogCommandOperationsUseCase<MeasureUnitCatalog> catalogCommandOperationsUseCase, 
        ...
        /// <summary>
        /// Get all measure unit catalog records ordered by id and descended way.
        /// </summary>
        /// <returns>The successfully completed task.</returns>
        public async Task<Task> ShowAllRecordsAsync()
        {
            //InputPort(Interactor) Logic
            ResponseResult<IEnumerable<MeasureUnitCatalog>> response = new();
        ...
        /// <summary>
        /// Get one single measure unit catalog record.
        /// </summary>
        /// <param name="id">Appertain to measure unit catalog identifier.</param>
        /// <param name="request">Appertain to requestDto object from measure unit catalog.</param>
        /// <returns>The successfully completed task.</returns>
        ...
        public async Task<Task> ShowRecordAsync(int id, RequestCatalogDto request)
        {
            ...
            //InputPort(Interactor) Logic
            ResponseResult<MeasureUnitCatalog> response = new();
        ...
        /// <summary>
        /// Create measure unit catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from measure unit catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        public async Task<Task> CreateRecordAsync(RequestCatalogDto request)
        {
            ...
            else
            {
                request.Id = 0;
                request.Code = null;
                var entityMapping = _mapper.Map<MeasureUnitCatalog>(request);
        ...
        /// <summary>
        /// Update measure unit catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from measure unit catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        /// <summary>
        /// Remove measure unit catalog record
        /// </summary>
        /// <param name="id">Appertain to measure unit catalog identifier.</param>
        /// <param name="request">Appertain to requestDto object from measure unit catalog.</param>
        /// <returns>The successfully completed task.</returns>

...
{
    public class OutputCatalogCrudInteractor : ICatalogUseCaseInputPort<OutputTypeCatalog>
    {
        private readonly ICatalogQueryOperationsUseCase<OutputTypeCatalog> _catalogQueryOperationsUseCase;
        private readonly ICatalogCommandOperationsUseCase<OutputTypeCatalog> _catalogCommandOperationsUseCase;
        ...
        public OutputCatalogCrudInteractor(ICatalogQueryOperationsUseCase<OutputTypeCatalog> catalogQueryOperationsUseCase, 
            ICatalogCommandOperationsUseCase<OutputTypeCatalog> catalogCommandOperationsUseCase, 
        ...
        /// <summary>
        /// Get all output type catalog records ordered by id and descended way.
        /// </summary>
        /// <returns>The successfully completed task.</returns>
        public async Task<Task> ShowAllRecordsAsync()
        {
            //InputPort(Interactor) Logic
            ResponseResult<IEnumerable<OutputTypeCatalog>> response = new();
        ...
        /// <summary>
        /// Get one single output type catalog record.
        /// </summary>
        /// <param name="id">Appertain to output type catalog identifier.</param>
        /// <param name="request">Appertain to requestDto object from output type catalog.</param>
        /// <returns>The successfully completed task.</returns>
        ...
        public async Task<Task> ShowRecordAsync(int id, RequestCatalogDto request)
        {
            ...
            //InputPort(Interactor) Logic
            ResponseResult<OutputTypeCatalog> response = new();
        ...
        /// <summary>
        /// Create output type catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from output type catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        public async Task<Task> CreateRecordAsync(RequestCatalogDto request)
        {
            ...
            else
            {
                request.Id = 0;
                request.Code = null;
                var entityMapping = _mapper.Map<OutputTypeCatalog>(request);
        ...
        /// <summary>
        /// Update output type catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from output type catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        /// <summary>
        /// Remove output type catalog record
        /// </summary>
        /// <param name="id">Appertain to output type catalog identifier.</param>
        /// <param name="request">Appertain to requestDto object from output type catalog.</param>
        /// <returns>The successfully completed task.</returns>
